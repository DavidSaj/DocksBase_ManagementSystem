    ...
    <div style={{ minHeight: '100vh', background: '#f4f6f8', paddingBottom: 100 }}>
      ...
      <div style={{ padding: '20px 20px 0' }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
          <span style={{ padding: '4px 12px', borderRadius: 20, background: '#1a2d4a', color: '#fff', fontSize: 12, fontWeight: 700 }}>{PRIORITY_LABEL[selected.priority] ?? selected.priority}</span>
