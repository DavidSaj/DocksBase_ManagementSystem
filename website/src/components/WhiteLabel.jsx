      ...
      <div className={styles.inner}>
        ...
        <div className={styles.left}>
          ...
          <div className={styles.hostedCard}>
            <div className={styles.hostedCardIcon}>
            ...
            <div>
              <p className={styles.hostedCardTitle}>No custom domain? No problem.</p>
              <p className={styles.hostedCardBody}>
                We host your portal at{' '}
                <span className={styles.hostedUrl}>booking.docksbase.com/yourmarina</span>
          ...
          <div className={styles.browser}>
            ...
            <div className={styles.chrome}>
              ...
              <div className={styles.urlBar}>
                ...
                <span className={styles.urlText}>booking.yourmarina.com</span>
              </div>
            </div>
